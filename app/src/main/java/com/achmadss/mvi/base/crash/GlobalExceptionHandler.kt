...
class GlobalExceptionHandler private constructor(
    ...
    private fun launchActivity(
        ...
        val intent = Intent(applicationContext, activity).setAction("application.crash").apply {
    ...
    companion object {
        ...
        fun getThrowableFromIntent(intent: Intent): Throwable? {
            return try {
                ...
                Log.e("GlobalExceptionHandler", e.message ?: "Wasn't able to retrieve throwable from intent")
                null
            }
        }
    }
